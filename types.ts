...
export interface CreatorStudioProject extends ProjectBase {
  ...
  editPrompt: string;
  isEditing: boolean;
  rotationImages: ImageFile[];
  isGeneratingRotation: boolean;
}


// --- App View ---
export type AppView = 'creator_studio' | 'photoshoot_director' | 'prompt_studio' | 'voice_over_studio' | 'campaign_studio' | 'video_studio' | 'plan_studio' | 'edit_studio' | 'storyboard_studio' | 'marketing_studio' | 'controller_studio' | 'ad_creative_studio' | 'asset_vault';
...
export interface AdCreativeStudioState {
    productImages: ImageFile[];
    adPlatform: 'Facebook' | 'TikTok' | 'Google' | 'Instagram';
...
export interface AdCreativeStudioProject extends ProjectBase, AdCreativeStudioState {}
...
export interface MarketingStudioState {
    ...
    language: 'ar' | 'en';
    result: string | null;
    brandImages: ImageFile[];
    socialDrafts: { platform: string; content: string; hashtags: string[] }[];
    isGenerating: boolean;
    error: string | null;
}
